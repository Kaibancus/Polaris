...
public sealed class SaturnRingTheme : PanelTheme
{
    ...
    // Default 30% transparency: with the Saturn density remap this renders ≈0.88 opacity
    // (dense black panel with a hint of wallpaper showing through).
    public override double DefaultTransparency => 0.30;
